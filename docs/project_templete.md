...
- launchDate: `YYYY-MM` 또는 `YYYY-Qn` (예: `2025-10` / `2025-Q4`)
- client: (예: Internal / Brand name / Confidential)
- technologies: [예: "Roblox Studio", "Luau", ...]

### 2) 링크 (빈 값은 `""`)
- play: (Roblox place URL)
- trailer: (YouTube 등)
- article: (보도/블로그)
- group: (Roblox 그룹 URL, 있을 경우)
...
### 4) 에셋 경로
- thumbnail: `images/<slug>-preview.jpg`
- main image: `images/<slug>-main.jpg` (상세 페이지 만들 경우)
- gallery: `images/<slug>-gallery-0.jpg`, `...-1.jpg`, ...
