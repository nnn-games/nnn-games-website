# Legendary DJ Gear 상세 페이지 작업 계획

- **slug**: `legendary-dj-gear`
- **HTML**: `legendary-dj-gear.html`
- **콘텐츠 설정 파일**: `js/project-details/legendary-dj-gear.js`
- **카드 메타 위치**: `data/projects.json` (id: `legendary-dj-gear`)
...
- [ ] `js/project-details/legendary-dj-gear.js` 콘텐츠 입력 (KO / EN / JA)
