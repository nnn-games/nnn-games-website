# Mine Sweeper 상세 페이지 작업 계획

- **slug**: `mine-sweeper`
- **HTML**: `mine-sweeper.html`
- **콘텐츠 설정 파일**: `js/project-details/mine-sweeper.js`
- **카드 메타 위치**: `data/projects.json` (id: `mine-sweeper`)
...
- [ ] `js/project-details/mine-sweeper.js` 콘텐츠 입력 (KO / EN / JA)
