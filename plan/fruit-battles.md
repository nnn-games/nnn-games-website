# Fruit Battles 상세 페이지 작업 계획

- **slug**: `fruit-battles`
- **HTML**: `fruit-battles.html`
- **콘텐츠 설정 파일**: `js/project-details/fruit-battles.js`
- **카드 메타 위치**: `data/projects.json` (id: `fruit-battles`)
...
- [ ] `js/project-details/fruit-battles.js` 콘텐츠 입력 (KO / EN / JA)
