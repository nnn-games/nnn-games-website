# Reset Tower 상세 페이지 작업 계획

- **slug**: `reset-tower`
- **HTML**: `reset-tower.html`
- **콘텐츠 설정 파일**: `js/project-details/reset-tower.js`
- **카드 메타 위치**: `data/projects.json` (id: `reset-tower`)
...
- [ ] `js/project-details/reset-tower.js` 콘텐츠 입력 (KO / EN / JA)
