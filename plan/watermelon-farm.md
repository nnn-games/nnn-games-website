# Watermelon Farm 상세 페이지 작업 계획

- **slug**: `watermelon-farm`
- **HTML**: `watermelon-farm.html`
- **콘텐츠 설정 파일**: `js/project-details/watermelon-farm.js`
- **카드 메타 위치**: `data/projects.json` (id: `watermelon-farm`)
...
- [ ] `js/project-details/watermelon-farm.js` 콘텐츠 입력 (KO / EN / JA)
